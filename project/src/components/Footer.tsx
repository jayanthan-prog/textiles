...
const Footer = () => {
  return (
    <footer className="bg-[#008bcc] text-white pt-12 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/infrastructure" className="text-gray-200 hover:text-white transition-colors">Infrastructure</Link></li>
              <li><Link to="/career" className="text-gray-200 hover:text-white transition-colors">Career</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-200">+91 98433 99161</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-blue-500" />
                <span className="text-gray-200">contactus@ashoktextilemills.com</span>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin className="h-5 w-5 text-blue-500 flex-shrink-0" />
                <span className="text-gray-200">10/243, Thuraiyur Main Road, Ponneri (PO), Namakkal–13</span>
              </li>
            </ul>
          </div>
